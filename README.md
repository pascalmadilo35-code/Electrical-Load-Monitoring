...
Electrical Load Monitoring &amp; Billing Simulator MID SEMESTER CAPSTONE PROJECT Name:Pascal madilo Student ID:01242014D Course: EEE 227 (PT) Programme: HND Electrical Engineering (Level 200) Development Environment: VS Code (Windows) Programming Language: C++ Data Storage: Text File using fstream
Project Overview
